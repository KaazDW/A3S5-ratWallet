 ...
 */
final class Version20231128174612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE account (id INT AUTO_INCREMENT NOT NULL, user_id_id INT DEFAULT NULL, balance DOUBLE PRECISION NOT NULL, creation_date DATETIME NOT NULL, name_account VARCHAR(255) NOT NULL, INDEX IDX_7D3656A49D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
